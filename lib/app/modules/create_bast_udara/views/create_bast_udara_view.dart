...
class InputPenyediaJasa extends GetView<CreateBastUdaraController> {
      ...
      child: TextFormFieldWidget(
        ...
        onTap: () {
          ...
          Get.bottomSheet(
            ...
            GetBuilder<CreateBastUdaraController>(
              builder: (controller) {
                return Column(
                  children: [
                    ListTile(
...
class InputPurchaseOrder extends GetView<CreateBastUdaraController> {
...
class InputAlamat extends GetView<CreateBastUdaraController> {
  const InputAlamat({
    super.key,
  });
...
class InputTanggalSerahTerima extends GetView<CreateBastUdaraController> {
...
class InputDurasiPengerjaan extends GetView<CreateBastUdaraController> {
...
class InputFotoPenyediaJasa extends GetView<CreateBastUdaraController> {
  ...
  @override
  Widget build(BuildContext context) {
    return GetBuilder<CreateBastUdaraController>(
      builder: (controller) {
...
class InputFotoSerahTerima extends GetView<CreateBastUdaraController> {
...
class InputUdara extends GetView<CreateBastUdaraController> {
  const InputUdara({
    super.key,
  });
                              ...
                              return ListTile(
                                ...
                                onTap: () {
                                  if (controller.listUdara!
                                    ...
                                    controller.listUdara!
                                        .add(Udara(imigran: item));
                                  }
                                  controller.update();
                                },
                              );
