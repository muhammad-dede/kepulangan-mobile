...
class CreateBastPihakLainView extends GetView<CreateBastPihakLainController> {
  const CreateBastPihakLainView({Key? key}) : super(key: key);
  @override
...
class InputPihakKedua extends GetView<CreateBastPihakLainController> {
  ...
  @override
  Widget build(BuildContext context) {
    return GetBuilder<CreateBastPihakLainController>(
      builder: (controller) {
        return Container(
...
void showPihakKedua() {
  Get.bottomSheet(
    ...
    enableDrag: false,
    isDismissible: false,
    GetBuilder<CreateBastPihakLainController>(
      builder: (controller) {
        return Scaffold(
...
class InputTanggalSerahTerima extends GetView<CreateBastPihakLainController> {
...
class InputFotoPihakKedua extends GetView<CreateBastPihakLainController> {
...
class InputFotoSerahTerima extends GetView<CreateBastPihakLainController> {
...
class InputImigran extends GetView<CreateBastPihakLainController> {
  const InputImigran({
    super.key,
  });
