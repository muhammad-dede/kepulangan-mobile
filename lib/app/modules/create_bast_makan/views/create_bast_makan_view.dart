...
class InputPurchaseOrder extends GetView<CreateBastMakanController> {
...
class InputPenyediaJasa extends GetView<CreateBastMakanController> {
      ...
      child: TextFormFieldWidget(
        ...
        onTap: () {
          ...
          Get.bottomSheet(
            ...
            GetBuilder<CreateBastMakanController>(
              builder: (controller) {
                return Column(
                  children: [
                    ListTile(
...
class InputAlamat extends GetView<CreateBastMakanController> {
  const InputAlamat({
    super.key,
  });
...
class InputTanggaSerahTerima extends GetView<CreateBastMakanController> {
...
class InputDurasiPengerjaan extends GetView<CreateBastMakanController> {
...
class InputWaktuSerahTerima extends GetView<CreateBastMakanController> {
...
class InputFotoPenyediaJasa extends GetView<CreateBastMakanController> {
  ...
  @override
  Widget build(BuildContext context) {
    return GetBuilder<CreateBastMakanController>(
      builder: (controller) {
...
class InputFotoSerahTerima extends GetView<CreateBastMakanController> {
...
class InputFotoInvoice extends GetView<CreateBastMakanController> {
...
class InputMakan extends GetView<CreateBastMakanController> {
  const InputMakan({
    super.key,
  });
