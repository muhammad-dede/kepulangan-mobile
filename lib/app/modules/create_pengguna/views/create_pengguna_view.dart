...
class Nama extends GetView<CreatePenggunaController> {
  const Nama({
    super.key,
  });
...
class NoIdentitas extends GetView<CreatePenggunaController> {
  const NoIdentitas({
    super.key,
  });
...
class Jabatan extends GetView<CreatePenggunaController> {
  const Jabatan({
    super.key,
  });
...
class Group extends GetView<CreatePenggunaController> {
  const Group({
    super.key,
  });
      ...
      child: TextFormFieldWidget(
        ...
        onTap: () {
          ...
          Get.bottomSheet(
            ...
            GetBuilder<CreatePenggunaController>(
              builder: (controller) {
                return Column(
                  children: [
                    ListTile(
...
class Telepon extends GetView<CreatePenggunaController> {
  const Telepon({
    super.key,
  });
...
class Email extends GetView<CreatePenggunaController> {
  const Email({
    super.key,
  });
...
class Role extends GetView<CreatePenggunaController> {
  const Role({
    super.key,
  });
...
class Password extends GetView<CreatePenggunaController> {
  const Password({
    super.key,
  });
  ...
  @override
  Widget build(BuildContext context) {
    return GetBuilder<CreatePenggunaController>(
      builder: (controller) {
        return Container(
          margin: const EdgeInsets.symmetric(vertical: 10),
          child: TextFormFieldWidget(
...
class PasswordConfirmation extends GetView<CreatePenggunaController> {
