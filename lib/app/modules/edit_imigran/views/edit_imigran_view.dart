...
class Header extends GetView<EditImigranController> {
  const Header({
    super.key,
  });
...
class InputBrafaks extends GetView<EditImigranController> {
  const InputBrafaks({
    super.key,
  });
...
class InputPaspor extends GetView<EditImigranController> {
  const InputPaspor({
    super.key,
  });
...
class InputNama extends GetView<EditImigranController> {
  const InputNama({
    super.key,
  });
...
class InputJenisKelamin extends GetView<EditImigranController> {
  const InputJenisKelamin({
    super.key,
  });
      ...
      child: TextFormFieldWidget(
        ...
        onTap: () {
          ...
          Get.bottomSheet(
            ...
            GetBuilder<EditImigranController>(
              builder: (controller) {
                return Column(
                  children: [
                    ListTile(
...
class InputNegara extends GetView<EditImigranController> {
  const InputNegara({
    super.key,
  });
...
class InputProvinsi extends GetView<EditImigranController> {
  const InputProvinsi({
    super.key,
  });
...
class InputKabKota extends GetView<EditImigranController> {
  const InputKabKota({
    super.key,
  });
...
class InputAlamat extends GetView<EditImigranController> {
  const InputAlamat({
    super.key,
  });
...
class InputNoTelp extends GetView<EditImigranController> {
  const InputNoTelp({
    super.key,
  });
...
class InputJabatan extends GetView<EditImigranController> {
  const InputJabatan({
    super.key,
  });
...
class InputTanggalKedatangan extends GetView<EditImigranController> {
  const InputTanggalKedatangan({
    super.key,
  });
...
class InputGroup extends GetView<EditImigranController> {
  const InputGroup({
    super.key,
  });
...
class InputMasalah extends GetView<EditImigranController> {
  const InputMasalah({
    super.key,
  });
...
class InputKepulangan extends GetView<EditImigranController> {
...
class InputCargo extends GetView<EditImigranController> {
  const InputCargo({
    super.key,
  });
...
class InputFotoPmi extends GetView<EditImigranController> {
  const InputFotoPmi({
    super.key,
  });
    ...
    return GetBuilder<EditImigranController>(
      builder: (controller) {
        return ImagePickerWidget(
          ...
          imageNetwork: controller.fotoPmiOld,
          onDelete: () {
...
class InputFotoJenazah extends GetView<EditImigranController> {
    ...
    return GetBuilder<EditImigranController>(
      builder: (controller) {
        return ImagePickerWidget(
          ...
          imageNetwork: controller.fotoJenazahOld,
          onDelete: () {
...
class InputFotoPaspor extends GetView<EditImigranController> {
  const InputFotoPaspor({
    super.key,
  });
    ...
    return GetBuilder<EditImigranController>(
      builder: (controller) {
        return ImagePickerWidget(
          ...
          imageNetwork: controller.fotoPasporOld,
          onDelete: () {
...
class InputFotoBrafaks extends GetView<EditImigranController> {
    ...
    return GetBuilder<EditImigranController>(
      builder: (controller) {
        return ImagePickerWidget(
          ...
          imageNetwork: controller.fotoBrafaksOld,
          onDelete: () {
